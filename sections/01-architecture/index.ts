/**
 * The architecture of **GobstonesWeb2** combines several modules providing 
 * different functionalities
 * For each module, there will be a repository in the organization.
 * The guidelines ask for all repositories to share a basic configuration structure, 
 * and in order to ensure it, there is a special module, in repository 
 * [gobstones-scripts](https://github.com/gobstones/gobstones-scripts), that all 
 * repositories of **GobstonesWeb2** must depend on providing the means to automate 
 * such sharing. In this way, when the team decide to change something on the common 
 * configuration, all repositories can be easily updated.
 * 
 * The architecture of **GobstonesWeb2** is established by the dependencies between 
 * the modules provided by the different repositories belonging to the project, as 
 * presented in the following diagram:
 * 
 * ![GobstonesWeb2 Architecture Diagram](../media/diagram-of-components.svg)
 * 
 * <details>
 ...
 * * [`gobstones-board-react`](https://github.com/gobstones/gobstones/gobstones-board-react), the REACT layer over the gobstones-board,* [`gobstones-code-editor`](https://github.com/gobstones/gobstones/gobstones-code-editor), a code editor to use with Gobstones,
...
*
 * @module 01-Architecture-of-GobstonesWeb2
 * 
 */
