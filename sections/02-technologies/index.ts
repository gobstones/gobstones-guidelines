 ...
 * </summary><p>
 *  * If you want to know more on `Node.js` there are a lot of good 
 * books and tutorials on it. 
 * A good starting point to know the basics on `Node.js` is 
 ...
 * 
 * @module 02_00-Technologies-used-in-GobstonesWeb2
 * 
 */
import { installation_tutorial } from "./installation-tutorial";

export class technologies_used {
    name: string = 'technologies-used';
    type: string = 'section';
    parent: string = 'gobstones-guidelines';
    children: any[] = [ installation_tutorial ];
};
